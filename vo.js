    ...
    _createClass(Observable, [{
        ...
        value: function watch(key, fn) {
            if (typeof key === 'function') {
                _watch(key.bind(this.obj), fn);
            } else {
                _watch(this.obj, key, fn);
            }
        }
    }]);
...
function _watch(obj, key, fn) {
    ...
    var sub = new _Subscriber2.default(exp, fn);
...
module.exports = __webpack_require__(2).observe;
